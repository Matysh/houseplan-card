...
класса C); руками не правится. Шаг Validate «индекс ревью совпадает с
каталогом» красит push в `dev`, где `INDEX.md` расходится с каталогом (на
issue-ветках не судится: их переписывает конвейер). Правка `docs/reviews/`
