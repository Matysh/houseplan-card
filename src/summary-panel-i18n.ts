...
const dictionaries = {
  "en": {
    ...
    "summary.general_settings": "General settings",
    "summary.blocks": "Blocks",
    "summary.blocks_hint": "Arrange blocks, choose where they appear and add values.",
    "summary.block_count": "{count} of {limit}",
    "summary.show_local_hint": "The same setting as the show button in the House Plan header.",
    "summary.show_mobile_hint": "Allow the panel in Home Assistant’s narrow screen mode.",
    "summary.hide_block": "Hide block",
    "summary.show_block": "Show block",
    "summary.delete_block": "Delete block",
    "summary.scope": "Show block in",
    "summary.system_source": "System value",
  ...
  "ru": {
    ...
    "summary.general_settings": "Основные настройки",
    "summary.blocks": "Блоки",
    "summary.blocks_hint": "Настройте порядок, область отображения и показатели.",
    "summary.block_count": "{count} из {limit}",
    "summary.show_local_hint": "То же состояние, что у кнопки показа в шапке House Plan.",
    "summary.show_mobile_hint": "Разрешает показ в узком режиме Home Assistant.",
    "summary.hide_block": "Скрыть блок",
    "summary.show_block": "Показать блок",
    "summary.delete_block": "Удалить блок",
    "summary.scope": "Где показывать блок",
    "summary.system_source": "Системный показатель",
  ...
  "de": {
    ...
    "summary.general_settings": "Grundeinstellungen",
    "summary.blocks": "Blöcke",
    "summary.blocks_hint": "Reihenfolge, Anzeigebereiche und Werte festlegen.",
    "summary.block_count": "{count} von {limit}",
    "summary.show_local_hint": "Dieselbe Einstellung wie die Anzeigetaste im House-Plan-Kopfbereich.",
    "summary.show_mobile_hint": "Erlaubt die Anzeige im schmalen Bildschirmmodus von Home Assistant.",
    "summary.hide_block": "Block ausblenden",
    "summary.show_block": "Block anzeigen",
    "summary.delete_block": "Block löschen",
    "summary.scope": "Block anzeigen in",
    "summary.system_source": "Systemwert",
  ...
  "fr": {
    ...
    "summary.general_settings": "Paramètres généraux",
    "summary.blocks": "Blocs",
    "summary.blocks_hint": "Définissez l’ordre, les espaces d’affichage et les valeurs.",
    "summary.block_count": "{count} sur {limit}",
    "summary.show_local_hint": "Le même réglage que le bouton d’affichage dans l’en-tête de House Plan.",
    "summary.show_mobile_hint": "Autorise l’affichage dans le mode écran étroit de Home Assistant.",
    "summary.hide_block": "Masquer le bloc",
    "summary.show_block": "Afficher le bloc",
    "summary.delete_block": "Supprimer le bloc",
    "summary.scope": "Afficher le bloc dans",
    "summary.system_source": "Valeur système",
