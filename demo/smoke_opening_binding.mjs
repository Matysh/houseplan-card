  ...
  const result = {
    ...
    openingLockUsesPackageGeometryAndStates:
      Object.values(lockVisualMatrix).every((theme) => Object.values(theme).every((state) =>
        ...
        && state.footprint > 0))
      && lockVisualMatrix.light.locked.core === 'rgb(102, 209, 122)'
      && lockVisualMatrix.light.locked.shell === 'rgb(102, 209, 122)'
      && lockVisualMatrix.light.locked.glyph === 'rgb(255, 255, 255)'
      && lockVisualMatrix.dark.locked.core === 'rgb(102, 209, 122)'
      && lockVisualMatrix.dark.locked.shell === 'rgb(102, 209, 122)'
      && lockVisualMatrix.dark.locked.glyph === 'rgb(37, 37, 37)'
      && lockVisualMatrix.light.unlocked.core === 'rgb(240, 65, 12)'
      && lockVisualMatrix.light.unlocked.shell === 'rgb(240, 65, 12)'
      && lockVisualMatrix.light.unlocked.glyph === 'rgb(255, 255, 255)'
      && lockVisualMatrix.dark.unlocked.core === 'rgb(240, 65, 12)'
      && lockVisualMatrix.dark.unlocked.shell === 'rgb(240, 65, 12)'
