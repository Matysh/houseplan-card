  ...
  `}let _s=null,ms=null,gs=!1;const fs=new Set;function vs(){if(_s)return _s;try{const t=JSON.parse(localStorage.getItem("houseplan_card_cfg_v1")||"null");if(t&&t.config&&Array.isArray(t.config.spaces))return{config:t.config,rev:t.rev||0,layout:t.layout||{}}}catch{}return null}function bs(t){return _s?Promise.resolve(_s):ms||(ms=async function(t){const[e,i]=await Promise.all([t.callWS({type:"houseplan/config/get"}),t.callWS({type:"houseplan/layout/get"})]);if(_s={config:e?.config??null,rev:e?.rev??0,layout:i?.layout??{}},!gs&&t.connection?.subscribeEvents){gs=!0;const e=()=>{_s=null,fs.forEach(t=>t())};try{await t.connection.subscribeEvents(e,"houseplan_config_updated"),await t.connection.subscribeEvents(e,"houseplan_layout_updated")}catch{gs=!1}}return _s}(t).finally(()=>{ms=null}),ms)}class ys extends lt{constructor(){super(...arguments),this._spaces=null,this._spacesLoading=!1}setConfig(t){this._config=t}async _loadSpaces(){if(!this._spaces&&!this._spacesLoading&&this.hass){this._spacesLoading=!0;try{const t=await this.hass.callWS({type:"houseplan/config/get"});this._spaces=(t?.config?.spaces||[]).map(t=>({value:t.id,label:t.title||t.id}))}catch{this._spaces=[]}finally{this._spacesLoading=!1}}}get _lang(){return ss(this.hass,this._config?.language)}get _schema(){const t=this._spaces||[];return[t.length?{name:"space",selector:{select:{mode:"dropdown",options:t}}}:{name:"space",selector:{text:{}}},{name:"title",selector:{text:{}}},{name:"show_button",selector:{boolean:{}}},{name:"button_label",selector:{text:{}}},{name:"button_target",selector:{text:{}}},{name:"aspect_ratio",selector:{text:{}}},{name:"icon_size",selector:{number:{min:1,max:6,step:.1,mode:"box"}}}]}render(){if(!this.hass||!this._config)return G;this._loadSpaces();const t=this._lang,e={space:os(t,"editor.space"),title:os(t,"editor.title"),show_button:os(t,"editor.show_button"),button_label:os(t,"editor.button_label"),button_target:os(t,"editor.button_target"),aspect_ratio:os(t,"editor.aspect_ratio"),icon_size:os(t,"editor.icon_size")};return B`<ha-form
    ...
    `}_vacSource(t){const e=t.marker?.vacuum;if(!1===e?.live)return null;if(e?.source&&this.hass?.states[e.source])return e.source;for(const e of t.entities||[])if(Pi(this.hass?.states[e]))return e;return null}_vacEntity(t){return t.primary?.startsWith("vacuum.")?t.primary:(t.entities||[]).find(t=>t.startsWith("vacuum."))||null}_isVacDev(t){return!!this._vacEntity(t)}_vacTick(){if(this.hass)for(const t of this._devices){if(t.hidden||!this._isVacDev(t))continue;const e=this._vacSource(t);if(!e)continue;const i=this._vacEntity(t),s=Ni(this.hass.states[i||""]?.state),o=zi(this.hass.states[e]?.attributes);let n=this._vacRt.get(t.id);n||(n={trail:[],lastKey:"",lastTs:0,moving:!1,jump:!1,endedTs:0,lastPos:null},this._vacRt.set(t.id,n)),s&&!n.moving&&(n.trail=[],n.lastPos=null);const r=!1!==t.marker?.vacuum?.trail&&!o?.path;!s&&n.moving&&(n.endedTs=Date.now(),r&&n.lastPos&&(n.trail=Ri(n.trail,n.lastPos,40)),n.lastPos=null),n.moving=s;const a=o?.pos;if(s&&a){const t=a.x+":"+a.y;if(t!==n.lastKey){const e=Date.now();n.jump=n.lastTs>0&&e-n.lastTs>1e4,n.lastKey=t,n.lastTs=e,r&&n.lastPos&&(n.trail=Ri(n.trail,n.lastPos,40)),n.lastPos=[a.x,a.y]}}}}_renderVacSection(t){const e=this._devices.find(e=>e.id===t.devId);if(!e||!this._isVacDev(e))return G;const i=e.marker?.vacuum||{},s=this._vacSource(e),o=s?zi(this.hass?.states[s]?.attributes):null,n=!!(o&&o.rooms.length>=3),r=o?.pos?ti(this._t("vac.status_found"),{name:s||""}):this._t("vac.status_none"),a=Object.keys(i.calibration||{}),l=t=>{const i=this._serverCfg,s=i?.markers?.find(t=>t.id===e.id);s&&(s.vacuum={...s.vacuum||{},...t},this._regSignature="",this._saveConfig(),this.requestUpdate())};return B`
      ...
      <div class="bindbox vacbox">
        ...
        @pointercancel=${e=>this._vacFitPointer(e,t)}>${o}${a}${l}</svg>`}_renderVacuums(t,e){if(this._markup||"decor"===this._mode)return G;const i=this._space+"|"+e.x+"|"+e.y+"|"+e.w+"|"+e.h,s=this._vacJumpOnce||i!==this._vacViewKey;this._vacViewKey=i,this._vacJumpOnce=!1;const o=[],n=[];for(const i of t){if(i.hidden||!this._isVacDev(i))continue;const t=this._vacSource(i);if(!t)continue;const r=zi(this.hass?.states[t]?.attributes);if(!r)continue;const a=i.marker?.vacuum?.calibration?.[this._vacMapId(i,r)];if(!a||6!==a.length)continue;const l=this._vacRt.get(i.id),c=l?.moving??!1,h=!c&&l?.endedTs&&Date.now()-l.endedTs<6e5,d=this._vacSrvTrails[i.id],p=this._vacMapId(i,r),u=d?.current?.map_id===p&&Array.isArray(d.current.points)?d.current:null,_=d?.previous?.map_id===p&&Array.isArray(d.previous.points)?d.previous:null;if(!1!==i.marker?.vacuum?.trail&&_&&_.points.length>1){const t=_.points.map(([t,e])=>{const[i,s]=Ci(a,t,e);return i.toFixed(1)+","+s.toFixed(1)}).join(" ");n.push(j`<g class="prev"><polyline class="case" points="${t}"></polyline><polyline class="core" points="${t}"></polyline></g>`)}if(!1!==i.marker?.vacuum?.trail&&(c||h||u)){const t=u?.points||r.path||l?.trail||[],e=c&&(u||r.path)&&t.length>1?t.slice(0,-1):t;if(e.length>1){const t=e.map(([t,e])=>{const[i,s]=Ci(a,t,e);return i.toFixed(1)+","+s.toFixed(1)}).join(" ");n.push(j`<polyline class="case" points="${t}"></polyline><polyline class="core" points="${t}"></polyline>`)}}if(!c||!r.pos)continue;const[m,g]=Ci(a,r.pos.x,r.pos.y),f=(m-e.x)/e.w*100,v=(g-e.y)/e.h*100,b=l&&l.lastTs>0&&Date.now()-l.lastTs>6e4,y=i.marker?.icon||i.icon||"mdi:robot-vacuum";o.push(B`<div
