...
.dev .hval {
  ...
  `}let Pi=null,Ti=null,Ri=!1;const Ii=new Set;function Ni(){if(Pi)return Pi;try{const t=JSON.parse(localStorage.getItem("houseplan_card_cfg_v1")||"null");if(t&&t.config&&Array.isArray(t.config.spaces))return{config:t.config,rev:t.rev||0,layout:t.layout||{}}}catch{}return null}function Oi(t){return Pi?Promise.resolve(Pi):Ti||(Ti=async function(t){const[e,i]=await Promise.all([t.callWS({type:"houseplan/config/get"}),t.callWS({type:"houseplan/layout/get"})]);if(Pi={config:e?.config??null,rev:e?.rev??0,layout:i?.layout??{}},!Ri&&t.connection?.subscribeEvents){Ri=!0;try{await t.connection.subscribeEvents(()=>{Pi=null,Ii.forEach(t=>t())},"houseplan_config_updated")}catch{Ri=!1}}return Pi}(t).finally(()=>{Ti=null}),Ti)}class Li extends lt{constructor(){super(...arguments),this._spaces=null,this._spacesLoading=!1}setConfig(t){this._config=t}async _loadSpaces(){if(!this._spaces&&!this._spacesLoading&&this.hass){this._spacesLoading=!0;try{const t=await this.hass.callWS({type:"houseplan/config/get"});this._spaces=(t?.config?.spaces||[]).map(t=>({value:t.id,label:t.title||t.id}))}catch{this._spaces=[]}finally{this._spacesLoading=!1}}}get _lang(){return $i(this.hass,this._config?.language)}get _schema(){const t=this._spaces||[];return[t.length?{name:"space",selector:{select:{mode:"dropdown",options:t}}}:{name:"space",selector:{text:{}}},{name:"title",selector:{text:{}}},{name:"show_button",selector:{boolean:{}}},{name:"button_label",selector:{text:{}}},{name:"button_target",selector:{text:{}}},{name:"aspect_ratio",selector:{text:{}}},{name:"icon_size",selector:{number:{min:1,max:6,step:.1,mode:"box"}}}]}render(){if(!this.hass||!this._config)return G;this._loadSpaces();const t=this._lang,e={space:ki(t,"editor.space"),title:ki(t,"editor.title"),show_button:ki(t,"editor.show_button"),button_label:ki(t,"editor.button_label"),button_target:ki(t,"editor.button_target"),aspect_ratio:ki(t,"editor.aspect_ratio"),icon_size:ki(t,"editor.icon_size")};return B`<ha-form
    ...
    `}}Ui.properties={hass:{attribute:!1},_config:{state:!0},_snap:{state:!0}},Ui.styles=[Mi,n`
      .hp-static-title {
        font-weight: 700;
    ...
    </div>`}}Vi.properties={hass:{attribute:!1},_config:{state:!0},_space:{state:!0},_layout:{state:!0},_devices:{state:!0},_tip:{state:!0},_selId:{state:!0},_toast:{state:!0},_serverCfg:{state:!0},_mode:{state:!0},_tool:{state:!0},_path:{state:!0},_cursorPt:{state:!0},_mergeSel:{state:!0},_openingDialog:{state:!0},_openingInfo:{state:!0},_mergeDialog:{state:!0},_splitSel:{state:!0},_decorTool:{state:!0},_decorStyle:{state:!0},_decorDraft:{state:!0},_decorSel:{state:!0},_decorTextDialog:{state:!0},_areaSel:{state:!0},_nameSel:{state:!0},_roomDialog:{state:!0},_spaceDialog:{state:!0},_infoCard:{state:!0},_rulesDialog:{state:!0},_settingsDialog:{state:!0},_importDialog:{state:!0},_markerDialog:{state:!0},_zoom:{state:!0},_view:{state:!0}},Vi.styles=Mi,customElements.get("houseplan-card")||customElements.define("houseplan-card",Vi),window.customCards=window.customCards||[],window.customCards.find(t=>"houseplan-card"===t.type)||window.customCards.push({type:"houseplan-card",name:"House Plan Card",description:"Interactive house plan: spaces, rooms and devices with live states and drag layout."}),console.info("%c HOUSEPLAN-CARD %c v1.38.0 ","background:#3ea6ff;color:#04121f;font-weight:700","");
