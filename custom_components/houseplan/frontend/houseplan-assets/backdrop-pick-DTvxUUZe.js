...
>>>>>>>> 3e3192f2 (fix: keep large-plan interactions off the full render path):custom_components/houseplan/frontend/houseplan-assets/backdrop-pick-DTvxUUZe.js
    ...
    `}}function c(e,t){return{id:e,title:t,plan_url:null,view_box:[0,0,1,1],rooms:[],wall_segments:[]}}function u(e="file"){const t="draw"===e;return{source:e,showBorders:t,showNames:t,displayTouched:!1}}function p(e,t){if(e.displayTouched)return{...e,source:t};const i="draw"===t;return{...e,source:t,showBorders:i,showNames:i}}function g(e,t,i){return{...e,[t]:i,displayTouched:!0}}d.properties={text:{type:String},ariaLabel:{type:String,attribute:"aria-label"},pointerHover:{type:Boolean,attribute:"data-pointer-hover",reflect:!0},_open:{state:!0},_forceFallback:{state:!0}},d.styles=o`
    :host {
      display: none;
      flex: none;
  ...
  </hp-dialog>`}export{l as F,c as a,_ as b,H as c,p as d,C as e,s as f,u as i,a as p,F as r,m as s,g as t};
