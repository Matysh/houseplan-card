<<<<<<<< HEAD:dist/houseplan-assets/houseplan-onboarding-runtime-OTfIw5Do.js
globalThis.__HOUSEPLAN_BUILD_FINGERPRINT__="dc3d46c4e6364ac253af4a77471ef78d9e3660ff8ef53d71db496f0d1810b107";import{l as t,b0 as s,A as e,t as a,b as o,cj as l,ck as i,cl as h,cm as c,aZ as n,cn as r,cs as p,co as d,cp as _,cq as u,cr as g,ct as m,cu as b,dp as $,dq as f,dr as v,aY as y,a_ as w,ds as D}from"./houseplan-card-DF8Mj-Od.js";import{c as k,e as S,r as C,a as M}from"./backdrop-pick-jRfJBpDz.js";const F=1e3,x=t=>{if(!t.trim())return null;const s=Number(t.replace(",","."));return Number.isFinite(s)?s:null},T="dc3d46c4e6364ac253af4a77471ef78d9e3660ff8ef53d71db496f0d1810b107";class L{constructor(t){this.host=t,this._toggleServerPlans=async()=>{const t=this.host._spaceDialog;if(t)if(t.pickSaved)this.host._spaceDialog={...t,pickSaved:!1};else{this.host._spaceDialog={...t,pickSaved:!0,savedBusy:!0};try{const t=await this.host.hass.callWS({type:"houseplan/plans/list"}),s=this.host._spaceDialog;s&&(this.host._spaceDialog={...s,saved:t?.plans||[],savedBusy:!1})}catch(t){const s=this.host._spaceDialog;s&&(this.host._spaceDialog={...s,saved:[],savedBusy:!1}),this.host._showToast(this.host._t("toast.plans_list_failed",{err:this.host._errText(t)}))}}}}_help(l){const i=`${l}.aria`,h=t(this.host.hass,this.host._config?.language);return s(h,l)&&s(h,i)?o`<hp-help data-help-key=${l}
      ...
      ${s.map(s=>{return o`
========
globalThis.__HOUSEPLAN_BUILD_FINGERPRINT__="658d574e520113426c6209992c80d5df271a89675a24c1dede93e2dbfef3f64f";import{l as t,b0 as s,A as e,t as o,b as a,cj as l,ck as i,cl as h,cm as c,aZ as n,cn as r,cs as p,co as d,cp as _,cq as u,cr as g,ct as m,cu as b,dp as $,dq as f,dr as v,aY as y,a_ as w,ds as D}from"./houseplan-card-BzxFIhxQ.js";import{c as k,e as S,r as C,a as M}from"./backdrop-pick-CnrofSfs.js";const F=1e3,x=t=>{if(!t.trim())return null;const s=Number(t.replace(",","."));return Number.isFinite(s)?s:null},T="658d574e520113426c6209992c80d5df271a89675a24c1dede93e2dbfef3f64f";class L{constructor(t){this.host=t,this._toggleServerPlans=async()=>{const t=this.host._spaceDialog;if(t)if(t.pickSaved)this.host._spaceDialog={...t,pickSaved:!1};else{this.host._spaceDialog={...t,pickSaved:!0,savedBusy:!0};try{const t=await this.host.hass.callWS({type:"houseplan/plans/list"}),s=this.host._spaceDialog;s&&(this.host._spaceDialog={...s,saved:t?.plans||[],savedBusy:!1})}catch(t){const s=this.host._spaceDialog;s&&(this.host._spaceDialog={...s,saved:[],savedBusy:!1}),this.host._showToast(this.host._t("toast.plans_list_failed",{err:this.host._errText(t)}))}}}}_help(l){const i=`${l}.aria`,h=t(this.host.hass,this.host._config?.language);return s(h,l)&&s(h,i)?a`<hp-help data-help-key=${l}
      ...
      ${s.map(s=>{return a`
>>>>>>>> 57b80f08 (Панорама двигает сцену трансформом, viewBox пишется по бюджету):custom_components/houseplan/frontend/houseplan-assets/houseplan-onboarding-runtime-CUIzH2Pa.js
...
<<<<<<<< HEAD:dist/houseplan-assets/houseplan-onboarding-runtime-OTfIw5Do.js
              @input=${s=>{const e=s.target.value,a=x(e),o=null==a?null:f(a,this.host._imperial);this.host._spaceDialog={...t,cellCmInput:e,cellCmTouched:!0,cellCm:null!=o&&o>0?Math.max(.1,Math.min(F,o)):t.cellCm}}} />
========
              @input=${s=>{const e=s.target.value,o=x(e),a=null==o?null:f(o,this.host._imperial);this.host._spaceDialog={...t,cellCmInput:e,cellCmTouched:!0,cellCm:null!=a&&a>0?Math.max(.1,Math.min(F,a)):t.cellCm}}} />
>>>>>>>> 57b80f08 (Панорама двигает сцену трансформом, viewBox пишется по бюджету):custom_components/houseplan/frontend/houseplan-assets/houseplan-onboarding-runtime-CUIzH2Pa.js
          ...
          <label class="srcrow">
            ${this._boolInput(t.showBorders,s=>{this.host._spaceDialog=v(t,"showBorders",s)})}
          ...
          <label class="srcrow">
            ${this._boolInput(t.showNames,s=>{this.host._spaceDialog=v(t,"showNames",s)})}
          ...
          ${"static"===(t.bgMode??y(this.host._settings,{}))?a`
            <div class="colorrow">
          ...
          ${D.map(t=>[t,`fill.${t}`]).map(([s,o])=>a`<label class="srcrow">
        ...
        <div class="row dialog-action-footer" slot="footer">
          ...
          <div class="dialog-action-group dialog-action-commit">
            ...
            <button class="btn ghost" data-hp="dialog-cancel"
              @click=${o}>${this.host._t("btn.cancel")}</button>
            <button class="btn on" data-hp="dialog-confirm"
