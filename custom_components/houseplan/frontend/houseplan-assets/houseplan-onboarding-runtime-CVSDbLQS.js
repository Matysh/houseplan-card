globalThis.__HOUSEPLAN_BUILD_FINGERPRINT__="7121e2de5173f312895dbfc34e36c4a023158cfe12aa3da9b2bf9dc32745b08d";import{l as t,a_ as s,A as e,x as o,b as a,ci as l,cj as i,ck as h,cl as c,aX as n,cm as r,cr as p,cn as d,co as _,cp as u,cq as g,di as m,aW as b,aY as $,dj as v}from"./houseplan-card-CD6ogmzP.js";import{i as f,c as y,e as w,r as D,a as k,b as S,g as C,t as M}from"./backdrop-pick-BVprf77o.js";const F=1e3,x=t=>{if(!t.trim())return null;const s=Number(t.replace(",","."));return Number.isFinite(s)?s:null},T="7121e2de5173f312895dbfc34e36c4a023158cfe12aa3da9b2bf9dc32745b08d";class L{constructor(t){this.host=t,this._toggleServerPlans=async()=>{const t=this.host._spaceDialog;if(t)if(t.pickSaved)this.host._spaceDialog={...t,pickSaved:!1};else{this.host._spaceDialog={...t,pickSaved:!0,savedBusy:!0};try{const t=await this.host.hass.callWS({type:"houseplan/plans/list"}),s=this.host._spaceDialog;s&&(this.host._spaceDialog={...s,saved:t?.plans||[],savedBusy:!1})}catch(t){const s=this.host._spaceDialog;s&&(this.host._spaceDialog={...s,saved:[],savedBusy:!1}),this.host._showToast(this.host._t("toast.plans_list_failed",{err:this.host._errText(t)}))}}}}_help(l){const i=`${l}.aria`,h=t(this.host.hass,this.host._config?.language);return s(h,l)&&s(h,i)?a`<hp-help data-help-key=${l}
