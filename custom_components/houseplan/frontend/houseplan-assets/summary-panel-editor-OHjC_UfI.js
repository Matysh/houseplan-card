globalThis.__HOUSEPLAN_BUILD_FINGERPRINT__="642849adbe0f48427b01ec8ff9dc0da658c47eef179015d7e7a9e46e26f6342e";import{c as a,A as e}from"./houseplan-card-BXiGrP71.js";import{s,n as t,a as l,m as r,b as o,c as i,d as u}from"./summary-panel-runtime-loaded-EwI2oFqY.js";import"./form-kit.styles-BQP_HeRJ.js";const m=m=>{const{host:c,dialog:d,problems:n,t:b}=m,y=n.find(a=>"error"===a.kind),$=d.localShow!==d.baseLocalShow||!d.localOnly&&!s(t(d.draft),d.base),p=$&&!d.busy&&!y,v=a=>n.find(e=>e.path===a),h=a=>a?b(`summary.problem.${a.code}`):"",k=()=>m.close(),g=a`<label class="summary-switch" for="summary-local-show">
