globalThis.__HOUSEPLAN_BUILD_FINGERPRINT__="738a55c8b059d491f42633c6ed706b143a2d58c094f9ac63668a53731377beff";import{l as t,b0 as s,A as e,x as o,b as a,ck as l,cl as i,cm as h,cn as c,aZ as n,co as r,ct as p,cp as d,cq as _,cr as u,cs as g,cu as m,cv as b,dp as $,dq as v,dr as f,aY as y,a_ as w,ds as D}from"./houseplan-card-D1iTv8-n.js";import{c as k,e as S,r as C,a as M}from"./backdrop-pick-BbiWskdP.js";const F=1e3,x=t=>{if(!t.trim())return null;const s=Number(t.replace(",","."));return Number.isFinite(s)?s:null},T="738a55c8b059d491f42633c6ed706b143a2d58c094f9ac63668a53731377beff";class L{constructor(t){this.host=t,this._toggleServerPlans=async()=>{const t=this.host._spaceDialog;if(t)if(t.pickSaved)this.host._spaceDialog={...t,pickSaved:!1};else{this.host._spaceDialog={...t,pickSaved:!0,savedBusy:!0};try{const t=await this.host.hass.callWS({type:"houseplan/plans/list"}),s=this.host._spaceDialog;s&&(this.host._spaceDialog={...s,saved:t?.plans||[],savedBusy:!1})}catch(t){const s=this.host._spaceDialog;s&&(this.host._spaceDialog={...s,saved:[],savedBusy:!1}),this.host._showToast(this.host._t("toast.plans_list_failed",{err:this.host._errText(t)}))}}}}_help(l){const i=`${l}.aria`,h=t(this.host.hass,this.host._config?.language);return s(h,l)&&s(h,i)?a`<hp-help data-help-key=${l}
