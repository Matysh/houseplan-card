        ...
        <div class="body">
          ...
          <label class="srcrow">
            <input type="radio" name="plansrc" .checked=${"file"===t.source}
              @change=${()=>this.host._spaceDialog=f(t,"file")} />
          ...
          <label class="srcrow">
            <input type="radio" name="plansrc" .checked=${"draw"===t.source}
              @change=${()=>this.host._spaceDialog=f(t,"draw")} />
          ...
          <label class="srcrow">
            ${this._boolInput(t.showBorders,s=>{this.host._spaceDialog=y(t,"showBorders",s)})}
          ...
          <label class="srcrow">
            ${this._boolInput(t.showNames,s=>{this.host._spaceDialog=y(t,"showNames",s)})}
