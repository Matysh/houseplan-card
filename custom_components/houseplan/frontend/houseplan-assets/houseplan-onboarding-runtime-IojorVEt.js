        ...
        <div class="body">
          ...
          <div class="colorrow">
            <input id="onboarding-space-cell-cm" class="namein tempin" type="number"
              ...
              @input=${s=>{const e=s.target.value,a=x(e),o=null==a?null:m(a,this.host._imperial);this.host._spaceDialog={...t,cellCmInput:e,cellCmTouched:!0,cellCm:null!=o&&o>0?Math.max(.1,Math.min(F,o)):t.cellCm}}} />
