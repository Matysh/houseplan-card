globalThis.__HOUSEPLAN_BUILD_FINGERPRINT__="a4eb6988aaa19c2c59f66beb5ac3db29d11d0730cda50fc9d5041f54bf7334c1";import{b as e,A as t}from"./houseplan-card-Dp-WMK_A.js";import{s as a,n as s,m as l,a as o,b as i,c as r}from"./summary-panel-runtime-loaded-CHQAgpMO.js";const c=c=>{const{host:u,dialog:n,local:m,problems:d,t:p}=c,$=d.find(e=>"error"===e.kind),b=n.localShow!==n.baseLocalShow||!n.localOnly&&!a(s(n.draft),n.base),y=b&&!n.busy&&!$,v=e=>d.find(t=>t.path===e),h=e=>e?p(`summary.problem.${e.code}`):"",k=()=>c.close(),g=e`<label class="summary-switch"><input type="checkbox"
      .checked=${n.localShow}
