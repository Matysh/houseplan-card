globalThis.__HOUSEPLAN_BUILD_FINGERPRINT__="fb1a7d387b2900fb1a108215450e0b1cb0c649e3fe4cb21ba558be186c23c71b";import{l as t,aK as s,A as e,t as o,c as a,ca as l,cb as i,cc as h,cd as c,aH as n,ce as r,cj as p,cf as _,cg as d,ch as u,ci as g,db as m,aG as b,aI as $,dc as v}from"./houseplan-card-6G7OmtFg.js";import{i as f,c as y,e as w,r as D,a as k,b as S,d as C,t as M}from"./backdrop-pick-O29mDmnF.js";const F=1e3,x=t=>{if(!t.trim())return null;const s=Number(t.replace(",","."));return Number.isFinite(s)?s:null},T="fb1a7d387b2900fb1a108215450e0b1cb0c649e3fe4cb21ba558be186c23c71b";class L{constructor(t){this.host=t,this._toggleServerPlans=async()=>{const t=this.host._spaceDialog;if(t)if(t.pickSaved)this.host._spaceDialog={...t,pickSaved:!1};else{this.host._spaceDialog={...t,pickSaved:!0,savedBusy:!0};try{const t=await this.host.hass.callWS({type:"houseplan/plans/list"}),s=this.host._spaceDialog;s&&(this.host._spaceDialog={...s,saved:t?.plans||[],savedBusy:!1})}catch(t){const s=this.host._spaceDialog;s&&(this.host._spaceDialog={...s,saved:[],savedBusy:!1}),this.host._showToast(this.host._t("toast.plans_list_failed",{err:this.host._errText(t)}))}}}}_help(l){const i=`${l}.aria`,h=t(this.host.hass,this.host._config?.language);return s(h,l)&&s(h,i)?a`<hp-help data-help-key=${l}
