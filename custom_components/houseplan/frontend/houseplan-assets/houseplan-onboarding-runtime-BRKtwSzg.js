      ...
      icon="mdi:home-floor-1" @hp-close=${()=>this.host._importDialog=null}>
        ...
        <div class="row" slot="footer">
          ...
          <button class="btn on" data-hp="dialog-confirm"
            @click=${()=>this._startImport()} ?disabled=${!s}>
        ...
        <div class="body">
          ...
          <label class="srcrow">
            <input type="radio" name="plansrc" .checked=${"file"===t.source}
              @change=${()=>this.host._spaceDialog=$(t,"file")} />
          ...
          <label class="srcrow">
            <input type="radio" name="plansrc" .checked=${"draw"===t.source}
              @change=${()=>this.host._spaceDialog=$(t,"draw")} />
          ...
          <div class="colorrow">
            <input id="onboarding-space-cell-cm" class="namein tempin" type="number"
              ...
              @input=${s=>{const e=s.target.value,a=x(e),o=null==a?null:v(a,this.host._imperial);this.host._spaceDialog={...t,cellCmInput:e,cellCmTouched:!0,cellCm:null!=o&&o>0?Math.max(.1,Math.min(F,o)):t.cellCm}}} />
          ...
          <label class="srcrow">
            ${this._boolInput(t.showBorders,s=>{this.host._spaceDialog=f(t,"showBorders",s)})}
          ...
          <label class="srcrow">
            ${this._boolInput(t.showNames,s=>{this.host._spaceDialog=f(t,"showNames",s)})}
          ...
          ${"static"===(t.bgMode??y(this.host._settings,{}))?o`
            <div class="colorrow">
              <hp-color-opacity .label=${this.host._t("space.bg_color")}
                .pickerLabels=${this.host._colorPickerLabels}
                .color=${t.bgColor||w(this.host._settings,{bgColor:null})||this.host._stageBgHex()}
          ...
          ${D.map(t=>[t,`fill.${t}`]).map(([s,a])=>o`<label class="srcrow">
        ...
        <div class="row dialog-action-footer" slot="footer">
          ...
          <div class="dialog-action-group dialog-action-commit">
            ...
            <button class="btn ghost" data-hp="dialog-cancel"
              @click=${a}>${this.host._t("btn.cancel")}</button>
            <button class="btn on" data-hp="dialog-confirm"
