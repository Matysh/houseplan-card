        ...
        <div class="body">
          ...
          <div class="colorrow">
            <input id="onboarding-space-cell-cm" class="namein tempin" type="number"
              min=${n(.1,this.host._imperial)}
              max=${n(F,this.host._imperial)}
              step="0.1"
              .value=${t.cellCmInput??n(t.cellCm,this.host._imperial)}
          ...
          <div class="colorrow">
            ...
            <span class="opl">${null===t.northDeg?this.host._t("space.north_inherited",{v:null===c(this.host._settings,{})?"—":`${c(this.host._settings,{})}°`}):"°"}</span>
          </div>
