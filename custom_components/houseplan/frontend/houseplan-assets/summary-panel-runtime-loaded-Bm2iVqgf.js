    ...
    ${z[t].map(t=>e`<path d=${t}></path>`)}
      ...
      <div class="summary-scroll">
        ${i.length?i.map(e=>s`<section class="summary-block">
          <h3>${e.title}</h3>
          ${e.values.length?e.values.map(e=>s`<div class="summary-value">
