...
.dev .hval {
  ...
  `}let wi=null,xi=null,$i=!1;const ki=new Set;function Si(){if(wi)return wi;try{const t=JSON.parse(localStorage.getItem("houseplan_card_cfg_v1")||"null");if(t&&t.config&&Array.isArray(t.config.spaces))return{config:t.config,rev:t.rev||0,layout:t.layout||{}}}catch{}return null}function Ci(t){return wi?Promise.resolve(wi):xi||(xi=async function(t){const[e,i]=await Promise.all([t.callWS({type:"houseplan/config/get"}),t.callWS({type:"houseplan/layout/get"})]);if(wi={config:e?.config??null,rev:e?.rev??0,layout:i?.layout??{}},!$i&&t.connection?.subscribeEvents){$i=!0;try{await t.connection.subscribeEvents(()=>{wi=null,ki.forEach(t=>t())},"houseplan_config_updated")}catch{$i=!1}}return wi}(t).finally(()=>{xi=null}),xi)}class Ei extends lt{constructor(){super(...arguments),this._spaces=null,this._spacesLoading=!1}setConfig(t){this._config=t}async _loadSpaces(){if(!this._spaces&&!this._spacesLoading&&this.hass){this._spacesLoading=!0;try{const t=await this.hass.callWS({type:"houseplan/config/get"});this._spaces=(t?.config?.spaces||[]).map(t=>({value:t.id,label:t.title||t.id}))}catch{this._spaces=[]}finally{this._spacesLoading=!1}}}get _lang(){return di(this.hass,this._config?.language)}get _schema(){const t=this._spaces||[];return[t.length?{name:"space",selector:{select:{mode:"dropdown",options:t}}}:{name:"space",selector:{text:{}}},{name:"title",selector:{text:{}}},{name:"show_button",selector:{boolean:{}}},{name:"button_label",selector:{text:{}}},{name:"button_target",selector:{text:{}}},{name:"aspect_ratio",selector:{text:{}}},{name:"icon_size",selector:{number:{min:1,max:6,step:.1,mode:"box"}}}]}render(){if(!this.hass||!this._config)return W;this._loadSpaces();const t=this._lang,e={space:ui(t,"editor.space"),title:ui(t,"editor.title"),show_button:ui(t,"editor.show_button"),button_label:ui(t,"editor.button_label"),button_target:ui(t,"editor.button_target"),aspect_ratio:ui(t,"editor.aspect_ratio"),icon_size:ui(t,"editor.icon_size")};return H`<ha-form
      ...
      <ha-card>
        ...
        <div class="head">
          ...
          ${this._canEdit?H`<div class="modes">
                ${[["view","mdi:eye-outline"],["plan","mdi:floor-plan"],["devices","mdi:tune-variant"]].map(([t,e])=>H`<button class="modetab ${this._mode===t?"active":""}"
          ...
          ${this._norm&&"devices"===this._mode?H`<button class="btn" @click=${()=>this._openMarkerDialog()}
    ...
    `}_renderDevice(t,e,i=!0){const s=this._pos(t),o=(s.x-e.x)/e.w*100,n=(s.y-e.y)/e.h*100,r=this._stateClass(t),a=this._liveTemp(t),l=this._liveHum(t),c=i&&!t.virtual?ei(this.hass,t.entities):null,h=t.marker,p=h?.display||"badge",d="ripple"===p||"icon_ripple"===p,u=t.primary?this.hass.states[t.primary]:void 0,g="value"===p?null!=a?a+"°":null!=l?l+"%":u&&!isNaN(parseFloat(u.state))?parseFloat(u.state)+(u.attributes?.unit_of_measurement?" "+u.attributes.unit_of_measurement:""):null:null,_=this._config?.live_states?function(t,e,i,s,o){if(o||!s||"unavailable"===s||"unknown"===s)return t;if("binary_sensor"===e){if("door"===i)return"on"===s?"mdi:door-open":"mdi:door-closed";if("window"===i)return"on"===s?"mdi:window-open":"mdi:window-closed";if("garage_door"===i)return"on"===s?"mdi:garage-open-variant":"mdi:garage-variant"}return"lock"===e?"locked"===s?"mdi:lock":"mdi:lock-open-variant":"light"===e&&"mdi:lightbulb"===t&&"on"===s?"mdi:lightbulb-on":t}(t.icon,t.primary?t.primary.split(".")[0]:null,u?.attributes?.device_class,u?.state,!!h?.icon):t.icon,m=d&&!!t.primary&&ke(this.hass.states[t.primary]?.state),f=Number(h?.size)>0?Number(h.size):1,v=Number(h?.angle)||0,b=Number(h?.ripple_size)>0?Number(h.ripple_size):3,y=[`left:${o}%`,`top:${n}%`];return 1!==f&&y.push(`--dev-scale:${f}`),d&&(y.push(`--ripple-scale:${b}`),h?.ripple_color&&y.push(`--ripple-color:${h.ripple_color}`)),H`<div
      class="dev ${r} ${this._selId===t.id?"sel":""} ${t.virtual?"virtual":""} ${"ripple"===p?"noicon":""} ${null!=g?"valonly":""}"
      style="${y.join(";")}"
    ...
    >
      ${d?H`<span class="ripple ${m?"active":""}"><i></i><i></i><i></i></span>`:W}
      ${null!=g?H`<span class="valtext">${g}</span>`:"ripple"!==p?H`<ha-icon icon="${_}" style=${v?`transform:rotate(${v}deg)`:W}></ha-icon>`:W}
    ...
    </div>`}}Ni.properties={hass:{attribute:!1},_config:{state:!0},_space:{state:!0},_layout:{state:!0},_devices:{state:!0},_tip:{state:!0},_selId:{state:!0},_toast:{state:!0},_serverCfg:{state:!0},_mode:{state:!0},_tool:{state:!0},_path:{state:!0},_cursorPt:{state:!0},_mergeSel:{state:!0},_openingDialog:{state:!0},_openingInfo:{state:!0},_mergeDialog:{state:!0},_splitSel:{state:!0},_areaSel:{state:!0},_nameSel:{state:!0},_roomDialog:{state:!0},_spaceDialog:{state:!0},_infoCard:{state:!0},_rulesDialog:{state:!0},_settingsDialog:{state:!0},_importDialog:{state:!0},_markerDialog:{state:!0},_zoom:{state:!0},_view:{state:!0}},Ni.styles=_i,customElements.get("houseplan-card")||customElements.define("houseplan-card",Ni),window.customCards=window.customCards||[],window.customCards.find(t=>"houseplan-card"===t.type)||window.customCards.push({type:"houseplan-card",name:"House Plan Card",description:"Interactive house plan: spaces, rooms and devices with live states and drag layout."}),console.info("%c HOUSEPLAN-CARD %c v1.26.0 ","background:#3ea6ff;color:#04121f;font-weight:700","");
