...
const ROWS = [
  ...
  ['L04', 'lifecycle.user_hidden', 'device-presentation-policy-lifecycle'],
  ['L05', 'lifecycle.user_hidden_preview', 'device-presentation-policy-lifecycle'],
  ['L06', 'lifecycle.orphaned_diagnostic', 'device-presentation-policy-lifecycle'],
