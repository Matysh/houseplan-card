<<<<<<< HEAD:dist/houseplan-assets/houseplan-onboarding-runtime-CIcTVu4w.js
<<<<<<<< HEAD:dist/houseplan-assets/houseplan-onboarding-runtime-CnjofBa1.js
...
>>>>>>>> 3e3192f2 (fix: keep large-plan interactions off the full render path):dist/houseplan-assets/houseplan-onboarding-runtime-CIcTVu4w.js
...
>>>>>>> 5ef300b8 (fix: satisfy render performance validation gates):dist/houseplan-assets/houseplan-onboarding-runtime-GJ38Op_d.js
      ${s.map(s=>{return a`
        ...
        <div class="body">
          ...
          <div class="colorrow">
            <input id="onboarding-space-cell-cm" class="namein tempin" type="number"
              ...
              @input=${s=>{const e=s.target.value,o=T(e),a=null==o?null:m(o,this.host._imperial);this.host._spaceDialog={...t,cellCmInput:e,cellCmTouched:!0,cellCm:null!=a&&a>0?Math.max(.1,Math.min(F,a)):t.cellCm}}} />
