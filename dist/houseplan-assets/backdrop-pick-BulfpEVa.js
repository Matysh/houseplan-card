  ...
  `,customElements.get("hp-help")||customElements.define("hp-help",c);function d(e,t,i){const o=(e?.spaces||[]).find(e=>e?.id===i),n=new Set((o?.rooms||[]).map(e=>String(e?.id||"")).filter(Boolean)),r=[...new Set((e?.markers||[]).filter(e=>!0!==e?.removed&&"string"==typeof e?.id).filter(e=>e.space===i||"string"==typeof e.room_id&&n.has(e.room_id)||t?.[String(e.id)]?.s===i).map(e=>String(e.id)))].sort((e,t)=>e.localeCompare(t)),s=(e?.markers||[]).filter(e=>!0!==e?.removed&&"string"==typeof e?.id).filter(e=>!r.includes(String(e.id))).filter(e=>((e,t)=>(e?.vacuum?.map_routes||[]).filter(e=>e&&e.space===t&&"string"==typeof e.id).map(e=>String(e.id)))(e,i).length>0).map(e=>String(e.id)).sort((e,t)=>e.localeCompare(t));return{markerIds:r,count:r.length,routeMarkerIds:s,routeCount:s.length}}function u(e,t,i){return i?`${e} ${t.replace("{count}",String(i))}`:e}const p=4096,g=1e6,_=()=>({kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null}),m=(e,t,i)=>{if(!Number.isInteger(e)||!Number.isInteger(t)||e<=0||t<=0||e>g||t>g)return{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null};const o=e*t*4;return{kind:Math.max(e,t)>16384?"hard":o>134217728?"warn":"safe",width:e,height:t,alpha:i,decodedBytes:o}},f=(e,t)=>(e[t]<<24|e[t+1]<<16|e[t+2]<<8|e[t+3])>>>0,w=(e,t)=>e[t]<<8|e[t+1],b=(e,t)=>e[t]|e[t+1]<<8|e[t+2]<<16,v=(e,t)=>e[t]|e[t+1]<<8,y=(e,t,i)=>{for(let o=0;o<i.length;o++)if(e[t+o]!==i.charCodeAt(o))return!1;return!0};function k(e,t){try{return"png"===t?function(e){if(e.length<33||2303741511!==f(e,0)||218765834!==f(e,4))return{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null};if(!y(e,12,"IHDR"))return{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null};const t=f(e,16),i=f(e,20),o=e[25];let n=4===o||6===o;if(!n){let t=33;for(let i=0;i<64&&t+8<=e.length;i++){const i=f(e,t);if(y(e,t+4,"tRNS")){n=!0;break}if(y(e,t+4,"IDAT")||y(e,t+4,"IEND"))break;if(i>e.length)break;t+=12+i}}return m(t,i,n)}(e):"jpg"===t?function(e){if(e.length<4||255!==e[0]||216!==e[1])return{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null};let t=2;for(let i=0;i<256&&t+4<=e.length;i++){if(255!==e[t]){t++;continue}const i=e[t+1];if(216===i||i>=208&&i<=217){t+=2;continue}if(i>=192&&i<=207&&196!==i&&200!==i&&204!==i)return t+9>e.length?_():m(w(e,t+7),w(e,t+5),!1);if(218===i)return _();const o=w(e,t+2);if(o<2)return _();t+=2+o}return{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null}}(e):"webp"===t?function(e){if(e.length<30||!y(e,0,"RIFF")||!y(e,8,"WEBP"))return{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null};if(y(e,12,"VP8X")){const t=!!(16&e[20]);return m(b(e,24)+1,b(e,27)+1,t)}if(y(e,12,"VP8 "))return 157!==e[23]||1!==e[24]||42!==e[25]?{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null}:m(16383&v(e,26),16383&v(e,28),!1);if(y(e,12,"VP8L")){if(47!==e[20])return{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null};const t=e[21]|e[22]<<8|e[23]<<16|e[24]<<24;return m(1+(16383&t),1+(t>>14&16383),1==(t>>28&1))}return{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null}}(e):{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null}}catch{return{kind:"unknown",width:null,height:null,alpha:!1,decodedBytes:null}}}function x(e,t,i=4096){const o=Math.min(1,i/Math.max(e,t));return{width:Math.max(1,Math.round(e*o)),height:Math.max(1,Math.round(t*o))}}const P={"image/svg+xml":"svg","image/png":"png","image/jpeg":"jpg","image/webp":"webp"};function T(e){return new Promise((t,i)=>{const o=new FileReader;o.onerror=()=>i(o.error||new Error("read failed")),o.onload=()=>{const e=String(o.result||""),n=e.indexOf(",");n<0?i(new Error("unexpected data url")):t(e.slice(n+1))},o.readAsDataURL(e)})}async function E(e,t=1.414){const i=URL.createObjectURL(e);try{return await new Promise(e=>{const o=new Image;o.onload=()=>e(o.naturalWidth&&o.naturalHeight?o.naturalWidth/o.naturalHeight:t),o.onerror=()=>e(t),o.src=i})}finally{URL.revokeObjectURL(i)}}async function $(e,t,i){const[o,n]=await Promise.all([T(e),E(e)]);return{ext:t,b64:o,aspect:n,name:i}}async function L(e,t=1/0){const i=function(e){return P[e.type]||(e.name.toLowerCase().endsWith(".svg")?"svg":"")}(e);if(!i)return{kind:"reject"};if("svg"===i)return{kind:"pass",ext:i};const o=k(new Uint8Array(await e.arrayBuffer()),i);return"safe"===o.kind&&e.size<=t?{kind:"pass",ext:i}:{kind:"guard",state:{file:e,ext:i,probe:o,busy:!1}}}async function M(e){const t=createImageBitmap(e.file,{imageOrientation:"from-image"}),i=await Promise.race([t,new Promise((e,t)=>{setTimeout(()=>t(new Error("decode timeout")),globalThis.__HP_BACKDROP_TIMEOUT_MS??1e4)})]);try{const{width:t,height:o}=x(i.width,i.height,p),n=e.probe.alpha,r=n?"image/png":"image/jpeg";let s;if("function"==typeof OffscreenCanvas){const e=new OffscreenCanvas(t,o),n=e.getContext("2d");if(!n)throw new Error("no 2d context");n.drawImage(i,0,0,t,o),s=await e.convertToBlob({type:r,quality:.9})}else{const e=document.createElement("canvas");e.width=t,e.height=o;const n=e.getContext("2d");if(!n)throw new Error("no 2d context");n.drawImage(i,0,0,t,o),s=await new Promise((t,i)=>{e.toBlob(e=>e?t(e):i(new Error("encode failed")),r,.9)})}const a=n?"png":"jpg";return{blob:s,ext:a,name:`${e.file.name.replace(/\.[^.]+$/,"")||"plan"}-reduced.${a}`}}finally{i.close()}}const C=e=>(e/1048576).toFixed(e>=10485760?0:1);function D(e,i,o,n,r,s=!0){const a=e._backdropGuard;if(!a)return null;const{probe:l}=a,h="hard"===l.kind,c=l.width&&l.height?x(l.width,l.height,p):null,d=h?e._t("backdrop.too_large_body",{w:l.width??0,h:l.height??0,limit:16384}):"unknown"===l.kind?e._t("backdrop.unknown_body"):e._t("backdrop.large_body",{w:l.width??0,h:l.height??0,fileMb:C(a.file.size),decodedMb:C(l.decodedBytes??0)}),u=()=>{e._backdropGuard?.busy||o()},g=()=>e._backdropGuard?.file===a.file;return t`<hp-dialog .hass=${n} data-kind="decor"
    ...
    <div class="row" slot="footer">
      <button class="btn ghost" data-hp="dialog-cancel"
        ?disabled=${a.busy} @click=${()=>u()}>
        ${e._t("btn.cancel")}</button>
      <span class="spacer"></span>
      ${h?null:t`
        ${s?t`
          <button class="btn ghost" data-hp="dialog-confirm"
            ?disabled=${a.busy} @click=${()=>(async()=>{if(e._backdropGuard?.busy)return;if(r)return e._backdropGuard={...a,busy:!0},e.requestUpdate?.(),await r(a.file,a.file.name),void(g()&&o());const t=await $(a.file,a.ext,a.file.name);g()&&(i(t),o())})()}>
            ${e._t("backdrop.keep_original")}</button>`:null}
        <button class="btn on" data-hp="dialog-confirm"
          ?disabled=${a.busy} @click=${()=>(async()=>{if(!e._backdropGuard?.busy){e._backdropGuard={...a,busy:!0},e.requestUpdate?.();try{const e=await M(a);if(r)return await r(e.blob,e.name),void(g()&&o());const t=await $(e.blob,e.ext,e.name);if(!g())return;i(t),o()}catch{if(!g())return;o(),e._showToast(e._t("backdrop.downscale_failed"))}}})()}>
          ${a.busy?e._t("backdrop.reducing"):e._t("backdrop.use_downscaled")}
        </button>`}
    </div>
  </hp-dialog>`}export{l as F,d as a,L as c,$ as e,s as f,a as p,D as r,u as s};
