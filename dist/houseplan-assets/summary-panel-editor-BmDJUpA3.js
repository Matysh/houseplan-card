globalThis.__HOUSEPLAN_BUILD_FINGERPRINT__="46764fa3974bb94f384c879659e0d7b2b2bb2e17e6c6d7406066137cdb4c31f0";import{c as a,A as e}from"./houseplan-card-Dah_d7rl.js";import{s,n as t,a as l,m as r,b as o,c as i,d as u}from"./summary-panel-runtime-loaded-Dr5eJpNN.js";import"./form-kit.styles-Bk3D5g6g.js";const m=m=>{const{host:c,dialog:d,problems:n,t:b}=m,y=n.find(a=>"error"===a.kind),$=d.localShow!==d.baseLocalShow||!d.localOnly&&!s(t(d.draft),d.base),p=$&&!d.busy&&!y,v=a=>n.find(e=>e.path===a),h=a=>a?b(`summary.problem.${a.code}`):"",k=()=>m.close(),g=a`<label class="summary-switch" for="summary-local-show">
