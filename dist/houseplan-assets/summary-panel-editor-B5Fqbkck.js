globalThis.__HOUSEPLAN_BUILD_FINGERPRINT__="a86b32ad6c4f7aa87dadebefc141b996b78fdeefe318dbe4eaaf0e100db9c6a8";import{b as e,A as t}from"./houseplan-card-C03N7VY3.js";import{s as a,n as s,m as l,a as o,b as i,c as r}from"./summary-panel-runtime-loaded-7CiqGnhK.js";const c=c=>{const{host:u,dialog:n,local:m,problems:d,t:p}=c,$=d.find(e=>"error"===e.kind),b=n.localShow!==n.baseLocalShow||!n.localOnly&&!a(s(n.draft),n.base),y=b&&!n.busy&&!$,v=e=>d.find(t=>t.path===e),h=e=>e?p(`summary.problem.${e.code}`):"",k=()=>c.close(),g=e`<label class="summary-switch"><input type="checkbox"
      .checked=${n.localShow}
