globalThis.__HOUSEPLAN_BUILD_FINGERPRINT__="012abf4b3924ad03971870eb8085ab1ac1a66b0d9b6676fe095285a8b0f201ab";import{c as a,A as e}from"./houseplan-card-CrTmJZ8b.js";import{s,n as t,a as l,m as r,b as o,c as i,d as u}from"./summary-panel-runtime-loaded-DQykYOsg.js";const m=m=>{const{host:c,dialog:d,problems:n,t:b}=m,y=n.find(a=>"error"===a.kind),$=d.localShow!==d.baseLocalShow||!d.localOnly&&!s(t(d.draft),d.base),p=$&&!d.busy&&!y,v=a=>n.find(e=>e.path===a),h=a=>a?b(`summary.problem.${a.code}`):"",k=()=>m.close(),g=a`<label class="summary-switch" for="summary-local-show">
