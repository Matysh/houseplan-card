...
.dev .hval {
  ...
  `}let Ai=null,Pi=null,Ri=!1;const Ii=new Set;function Ni(){if(Ai)return Ai;try{const t=JSON.parse(localStorage.getItem("houseplan_card_cfg_v1")||"null");if(t&&t.config&&Array.isArray(t.config.spaces))return{config:t.config,rev:t.rev||0,layout:t.layout||{}}}catch{}return null}function Oi(t){return Ai?Promise.resolve(Ai):Pi||(Pi=async function(t){const[e,i]=await Promise.all([t.callWS({type:"houseplan/config/get"}),t.callWS({type:"houseplan/layout/get"})]);if(Ai={config:e?.config??null,rev:e?.rev??0,layout:i?.layout??{}},!Ri&&t.connection?.subscribeEvents){Ri=!0;try{await t.connection.subscribeEvents(()=>{Ai=null,Ii.forEach(t=>t())},"houseplan_config_updated")}catch{Ri=!1}}return Ai}(t).finally(()=>{Pi=null}),Pi)}class Li extends lt{constructor(){super(...arguments),this._spaces=null,this._spacesLoading=!1}setConfig(t){this._config=t}async _loadSpaces(){if(!this._spaces&&!this._spacesLoading&&this.hass){this._spacesLoading=!0;try{const t=await this.hass.callWS({type:"houseplan/config/get"});this._spaces=(t?.config?.spaces||[]).map(t=>({value:t.id,label:t.title||t.id}))}catch{this._spaces=[]}finally{this._spacesLoading=!1}}}get _lang(){return $i(this.hass,this._config?.language)}get _schema(){const t=this._spaces||[];return[t.length?{name:"space",selector:{select:{mode:"dropdown",options:t}}}:{name:"space",selector:{text:{}}},{name:"title",selector:{text:{}}},{name:"show_button",selector:{boolean:{}}},{name:"button_label",selector:{text:{}}},{name:"button_target",selector:{text:{}}},{name:"aspect_ratio",selector:{text:{}}},{name:"icon_size",selector:{number:{min:1,max:6,step:.1,mode:"box"}}}]}render(){if(!this.hass||!this._config)return G;this._loadSpaces();const t=this._lang,e={space:ki(t,"editor.space"),title:ki(t,"editor.title"),show_button:ki(t,"editor.show_button"),button_label:ki(t,"editor.button_label"),button_target:ki(t,"editor.button_target"),aspect_ratio:ki(t,"editor.aspect_ratio"),icon_size:ki(t,"editor.icon_size")};return B`<ha-form
    ...
    </div>`}get _openWallHover(){if(!this._markup||"openwall"!==this._tool||!this._cursorPt)return null;const t=this._openWallHit(this._cursorPt);return t?{segs:t.segs,open:t.open}:null}_renderOpenWalls(){const t=this._openPairs(),e=this._openWallHover;if(!t.length&&!e)return j``;const i=this._markup&&"openwall"===this._tool;return j`<g class="openwalls ${i?"hot":""}">
      ${t.flatMap(t=>t.segs.map(t=>j`<line class="openwall"
        x1="${t[0]}" y1="${t[1]}" x2="${t[2]}" y2="${t[3]}"></line>`))}
      ${e?e.segs.map(t=>j`<line class="openwall-preview ${e.open?"willclose":""}"
        ...
        <div class="stage ${this._markup?"markup tool-"+this._tool+("split"!==this._tool||this._splitSel?"":" pickstage")+("openwall"===this._tool&&this._openWallHover?" wallhot":""):""} ${"decor"===this._mode?"dtool-"+this._decorTool:""} ${e.bg?"":"noplan"} mode-${this._mode}"
          ...
          <svg viewBox="${l.x} ${l.y} ${l.w} ${l.h}" preserveAspectRatio="xMidYMid meet">
            ...
            ${e.rooms.filter(t=>t.area||this._markup||o.showBorders).map(t=>{let i="room "+(e.bg?"overlay":"yard")+(this._markup?" outlined":"");!this._markup||t.id!==this._mergeSel&&t.id!==this._splitSel?.roomId||(i+=" picked");let s="";if(!this._markup&&(o.showBorders||"none"!==o.fill)){i+=" styled";const e=[];e.push(`--room-stroke:${o.color}`,`--room-stroke-op:${o.showBorders?o.opacity:0}`);const n="glow"===o.fill?this._fillColors.glow_base:t.area?Qe(o.fill,"lqi"===o.fill?this._roomLqi(t.area):null,"light"===o.fill?vi(this.hass,this._devices,t.area):"none","temp"===o.fill?yi(this.hass,this._devices,t.area):null,o.tempMin,o.tempMax,this._fillColors):null;n?(i+=" filled",e.push(`--room-fill:${n.c}`,`--room-fill-op:${n.a.toFixed(3)}`)):e.push("--room-fill:transparent","--room-fill-op:0"),s=e.join(";")}const r=e=>this._showTip(e,t.name,this._t("tip.room"),n?this._roomLqi(t.area):null,t.area?yi(this.hass,this._devices,t.area):null),a=!e.bg&&!o.showNames&&!this._markup,l=this._roomCenter(t),c=we(t),h=c?function(t,e,i=1e-6){const s=e.filter(e=>Re(t,e,i));return s.filter(t=>!s.some(e=>e!==t&&Re(e,t,i)))}(c,e.rooms.filter(e=>e!==t).map(t=>we(t)).filter(Boolean)):[],p=h.length&&c?j`<path class="${i}" style="${s}" fill-rule="evenodd"
                    ...
                    @click=${()=>this._clickRoom(t)} @mousemove=${r}
                    @mouseleave=${()=>this._tip=null}></rect>`;return j`${p}${a?j`<text class="rlabel" x="${l[0]}" y="${l[1]}">${t.name}</text>`:G}`})}
    ...
    ><span class="rlname">${t.name}</span>
      ...
      ${i.length>1?j`<polyline class="pathline" points="${i.map(t=>t.join(",")).join(" ")}"></polyline>`:G}
      ...
      ${(()=>{const t=this._openingPreview;if(!t)return G;const e=t.angle*Math.PI/180,i=Math.cos(e)*t.rlen/2,o=Math.sin(e)*t.rlen/2;return j`<line class="opghost" x1="${t.x-i}" y1="${t.y-o}"
      ...
      <div class="dialog wide" @click=${t=>t.stopPropagation()}>
        ...
        <div class="body">
          ...
          <div class="bindsel ${e?"virt":""}">
            ...
            ${e?G:B`<div class="curbind"><ha-icon icon="mdi:link-variant"></ha-icon>
