...
.dev .hval {
  ...
  `}let mi=null,_i=null,gi=!1;const fi=new Set;function vi(){if(mi)return mi;try{const t=JSON.parse(localStorage.getItem("houseplan_card_cfg_v1")||"null");if(t&&t.config&&Array.isArray(t.config.spaces))return{config:t.config,rev:t.rev||0,layout:t.layout||{}}}catch{}return null}function bi(t){return mi?Promise.resolve(mi):_i||(_i=async function(t){const[e,i]=await Promise.all([t.callWS({type:"houseplan/config/get"}),t.callWS({type:"houseplan/layout/get"})]);if(mi={config:e?.config??null,rev:e?.rev??0,layout:i?.layout??{}},!gi&&t.connection?.subscribeEvents){gi=!0;try{await t.connection.subscribeEvents(()=>{mi=null,fi.forEach(t=>t())},"houseplan_config_updated")}catch{gi=!1}}return mi}(t).finally(()=>{_i=null}),_i)}class yi extends lt{constructor(){super(...arguments),this._spaces=null,this._spacesLoading=!1}setConfig(t){this._config=t}async _loadSpaces(){if(!this._spaces&&!this._spacesLoading&&this.hass){this._spacesLoading=!0;try{const t=await this.hass.callWS({type:"houseplan/config/get"});this._spaces=(t?.config?.spaces||[]).map(t=>({value:t.id,label:t.title||t.id}))}catch{this._spaces=[]}finally{this._spacesLoading=!1}}}get _lang(){return ni(this.hass,this._config?.language)}get _schema(){const t=this._spaces||[];return[t.length?{name:"space",selector:{select:{mode:"dropdown",options:t}}}:{name:"space",selector:{text:{}}},{name:"title",selector:{text:{}}},{name:"show_button",selector:{boolean:{}}},{name:"button_label",selector:{text:{}}},{name:"button_target",selector:{text:{}}},{name:"aspect_ratio",selector:{text:{}}},{name:"icon_size",selector:{number:{min:1,max:6,step:.1,mode:"box"}}}]}render(){if(!this.hass||!this._config)return W;this._loadSpaces();const t=this._lang,e={space:ri(t,"editor.space"),title:ri(t,"editor.title"),show_button:ri(t,"editor.show_button"),button_label:ri(t,"editor.button_label"),button_target:ri(t,"editor.button_target"),aspect_ratio:ri(t,"editor.aspect_ratio"),icon_size:ri(t,"editor.icon_size")};return H`<ha-form
    ...
    `}_renderDevice(t,e){const i=this._pos(t),s=(i.x-e.x)/e.w*100,o=(i.y-e.y)/e.h*100,n=this._stateClass(t),r=this._liveTemp(t),a=this._liveHum(t),l=this._config?.show_signal&&!t.virtual?Ke(this.hass,t.entities):null;return H`<div
