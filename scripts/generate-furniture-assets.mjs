...
function renderPlan(symbols) {
  const runtime = symbols.map(({ id, group, category, w, h, art }) => ({
    id, group, category, w, h, art,
  }));
  return header + `export const GENERATED_FURNITURE_PLAN = ${JSON.stringify(runtime)} as const;\n`;
}
