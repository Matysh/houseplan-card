 ...
 * summary recovery сняты. Измеренный факт 299 771 Б оставляет 529 Б сверху и
 * 1 471 Б до нижней границы полосы; общий бюджет 301 066 Б и долг #367 не
 * меняются.
 */
export const INITIAL_VIEW_GZIP_CEILING = 300_300;
