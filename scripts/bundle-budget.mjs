 ...
 *
 * 2026-09-03, #162: потолок поднят 292 000 → 293 000. Причина — маршрутизация
 ...
 * больше. Факт 292 278 лежит в 722 Б от нового потолка и в 1 278 Б от нижней
 * границы полосы — обе стороны дальше шума.
 */
export const INITIAL_VIEW_GZIP_CEILING = 293_000;
