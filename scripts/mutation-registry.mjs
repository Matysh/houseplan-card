// Mutation declarations only. Runtime, selection and evidence code lives in
// separate modules so adding a witness cannot conflict with runner changes.
...
const MUTANT_DEFINITIONS = [
  ...
  // #481: журнал пойманных свидетелей — каждый защитный контракт под свидетелем.
  {
    ...
    patches: [{
      ...
      file: 'scripts/mutation-evidence.mjs',
  ...
  },
  {
    ...
    patches: [{
      file: 'scripts/mutation-selection.mjs',
