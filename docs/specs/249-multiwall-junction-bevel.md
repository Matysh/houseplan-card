...
4. локальное соединение имеет ненулевую площадь, node не попадает в hole wall
   body, а тела всех инцидентных rays входят в один связный кладочный компонент;
5. boolean union не вправе вернуть в body отброшенную дальнюю вершину из другого
