...
> Пункты этого исследования об отдельном редакторе границ (#148) являются
> историческими и заменены #306: отдельного инструмента и сущности виртуальной
> стены больше нет, используется обычная стена `cm:0`.
