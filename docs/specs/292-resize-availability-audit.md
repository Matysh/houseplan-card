...
не понимает, что именно мешает перемещению стены и что можно сделать.
...
click, Enter или Space объясняют ограничение обычным языком и, где применимо,
называют действие: сначала выпрямить почти осевую геометрию через Optimize либо
убрать перекрывающую независимую стену.
...
RU/EN тексты должны отвечать на два вопроса: «что мешает» и «что можно сделать».
Минимальный контракт:

| Класс | Пользовательский смысл |
|---|---|
| angled / side angle | стена или примыкание не горизонтально/вертикально; предложить Optimize, только если кандидат #290 существует |
...
Если Optimize не способен исправить конкретную стену, текст не должен обещать,
что Optimize её исправит.
