...
Статус: ревизия 5 (r1: M1/M2/L1; r2: M1 — AC7; поправки владельца 2026-08-27: §4 — острая вершина без фаски и без зазубрин на гранях). Решения владельца (чат, 2026-08-27, зафиксированы в issue):
...
- **AC7a (Resize, канал §2).** Resize, приводящий к нарушению любого из
  ...
  называет нарушенное правило. План байт-неизменен; тост не показывается.
  Смок проверяет и байт-неизменность, и текст объяснения ручки.
