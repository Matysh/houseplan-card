...
- Ревизия: 2 (2026-08-31) — по SPEC-REVIEW-396-r1 (High-1: перечень мест отмены)
...
| `:1159` `_onMotionChange`, `:2363` | `cancel(true)`, цель коммитится | уже сохраняется через `settled` |
| `:1401` `_cancelModeTransition` | смена режима | структурная |
| `:1551` `_commitSpace` | смена пространства | структурная |
| `:4188`, `:4216` `_load` | adoption конфига и layout | структурная |
