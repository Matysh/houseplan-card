...
Статус: ревизия 3 (r1: M1/M2/Low; r2: M3/M4). Родитель: #306 (стены нулевой толщины), контекст: #319
...
- Golden: правило 3.1 меняет видимое зонирование `cm:0` (атом под проёмом
  ...
  проёма с удалённым host — но это независимая кладка вне контурных атомов
  правила 3.1, поэтому ожидание — «без изменений»; решает `golden:verify`:
