...
| Item | State |
|---|---|
| Version | **v1.63.0-beta.2** everywhere (manifest, const.py, package.json, CARD_VERSION) — prerelease candidate |
| Current local cycle | v1.63.0-beta.2 preserves the exterior facade when Split starts or ends at a room corner (#123), using one wall geometry for flat/static/isometric rendering and light. The line also includes the v1.63.0-beta.1 empty-plan and opening-reference fixes (#111, #104), plus the reviewed process automation work #105 and #118–#121. |
