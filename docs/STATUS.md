...
| Item | State |
|---|---|
| Version | **v1.72.0-beta.4** everywhere (manifest, const.py, package.json, CARD_VERSION) |
| Current local cycle | v1.72.0-beta.4 adds room-free space copies (#456), directional Zigbee route arrows and contextual help (#457, #459), and deterministic live-editor settlement for reliable furniture previews (#460). Publish from `dev` only after exact-SHA Validate is green; `main` remains at v1.71.0. |
