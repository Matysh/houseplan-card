...
| Item | State |
|---|---|
| Version | **v1.67.0-beta.1 candidate** everywhere (manifest, const.py, package.json, CARD_VERSION) — first prerelease of the v1.67 line |
| Current local cycle | v1.67.0-beta.1 packages thirteen reviewed changes after v1.66.0: precision and safety work for Plan drawing, dimensions, wall chains and grid scale (#228, #230, #233, #234, #238, #239); fail-closed Optimize and canonical persisted geometry (#199, #223, #224, #229); plus space ordering, PDF-backup import and entity/parent marker deduplication (#220, #225, #226). Publication remains gated by the full exact-SHA Validate. |
