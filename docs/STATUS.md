...
| Current local cycle | v1.67.0-beta.7 is published. The next beta cycle adds exact explicit-Optimize reconciliation of a redundant partition over one solid shared room wall, including lossless hosted-opening reattachment and preserved physical envelope (#276); safe Resize (#277) and wall-union failure isolation (#278) follow sequentially before publication. |
