...
| Item | State |
|---|---|
| Version | **v1.60.2-beta.1** everywhere (manifest, const.py, package.json, CARD_VERSION) — pre-release with persistent unfinished outlines, independent partitions/columns and the complete follow-up review hardening. The tag points at `dev`; `main` remains on v1.60.0 |
