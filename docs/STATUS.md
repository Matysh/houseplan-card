...
| Current local cycle | **Post-v1.77 development** — stable v1.77.0 is the baseline. The next beta starts by repairing the authentic Home Assistant dialog lifecycle: after rejecting a close request, all four settings forms reopen the same modal and preserve their draft (#607). |
