...
| Item | State |
|---|---|
| Version | **v1.64.0-beta.2** everywhere (manifest, const.py, package.json, CARD_VERSION) — prerelease candidate on the v1.63.0 stable base |
| Current local cycle | v1.64.0-beta.2 packages the merged four-phase sun background (#146), visible plan snap topology (#137), shared-wall room autoclose (#138), seamless wall junctions (#141) and dialog-footer polish (#140), plus merged test, CI, process and documentation maintenance (#85, #115, #133, #135, #136, #139, #142). Exact-SHA Linux Validate, including golden and the beta performance smoke, remains the publication gate. The independent #124 exact-SHA view-toggle performance debt remains open under the owner's accepted exception. |
