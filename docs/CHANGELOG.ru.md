...
- Структурные изменения стен теперь сохраняют толщину, происхождение черновых
  ...
  изменении или через **«Оптимизировать планы»**; неоднозначная старая геометрия
  остаётся без изменений с подсказкой по восстановлению. Кнопки редактора плана
  и поведение стен нулевой толщины не менялись
