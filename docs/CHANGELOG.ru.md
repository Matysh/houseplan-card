...
- Четыре диалога настроек — «Пространство», «Общие настройки», «Настройки
  ...
  выпадающим (заливка комнаты, нулевые стены, фон, лучи солнца и их источник,
  ...
  0–359°, не выбранная привязка, неположительный радиус свечения) названы под
  полем, а ссылка «Проверить N полей» в футере ведёт к первому. Строка
