...
- Над планом появилась настраиваемая информационная панель: в ней можно
  ...
  план не смещается, пока новый контрол завершает компоновку; загрузка другого
  языка остаётся визуально нейтральной, а подписи комнат не меняют размер при
  переходе в редактор и исчезновении View-контролов
