...
- Рисование плана теперь останавливается там, где нельзя безопасно угадать
  ...
  разрыв до 2 см исправляется только вместе с подтверждённой комнатой. При
  удалении комнаты теперь можно явно оставить её физические стены либо удалить
  их; общие стены и их проёмы сохраняются
