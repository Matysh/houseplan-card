...
| Является источником света | **Авто** использует роль устройства, **Всегда** делает собственную управляемую сущность маркера источником, **Никогда** исключает только собственный источник. Внешние `controls` продолжают учитываться в свете комнаты |
...
ворота и арки — проходы, поэтому через них свет идёт дальше, а откосы толстой
