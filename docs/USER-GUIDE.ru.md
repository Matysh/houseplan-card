...
| Граница частичная, диагональная, затрагивает третью комнату или перекрыта независимой стеной/черновиком/колонной | Ручка остаётся видимой, но приглушена; наведение, фокус или нажатие объясняет запрет |
...
| Параметр | Поведение |
|---|---|
| Значение | 1–100 см; пусто/0 у стены комнаты очищает толщину, у отдельно стоящей стены — отклоняется (стена без толщины не существует) |
...
Та же проверка выполняется перед обычным изменением комнат, стен, виртуальных
границ, проёмов, перегородок, черновиков и колонн. Небезопасный результат
