...
запоминается в этом браузере. House Plan сам выбирает ориентацию листа и
стандартный масштаб. Экспорт ничего не изменяет в плане и всегда даёт
плоскую проекцию, даже если на экране включён изометрический вид. Подробные
правила измерений, лимиты изображений и сведения о шрифте есть в разделе
