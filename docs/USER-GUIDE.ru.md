...
граница температуры, север вне 0–359°, не выбранная привязка, неположительный
радиус свечения — подписано под полем красным, а ссылка **Проверить N полей** в
футере ведёт к первому такому полю.
...
| Внешний вид | Видимые слои | Две строки с тумблерами: **Декоративный слой** и **Двери, окна и ворота**. Включено — видно; выключенный декоративный слой не рисует линии, фигуры, текст и мебель в просмотре, выключенные проёмы скрывают только их символы — свет, солнечные лучи и датчики продолжают работать |
...
| Радиус свечения | Поле с единицей; пустое — общий радиус, подсказка называет его. Локально переопределяет общий радиус, 0.1–100 м в хранилище |
