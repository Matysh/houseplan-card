...
Цвет контура/текста/мебели и его прозрачность задаются общим компактным полем: нажмите на образец цвета, чтобы открыть выбор цвета и прозрачности. Толщина и размер текста хранятся физически и показываются в сантиметрах или дюймах. Поэтому при приближении плана контур мебели становится толще вместе с остальными физическими линиями, а при отдалении — тоньше; изменение ширины и глубины самого предмета толщину не искажает. Для прямоугольника и овала заливка имеет собственные цвет и прозрачность. Большие размеры в свойствах показываются в метрах или футах.
