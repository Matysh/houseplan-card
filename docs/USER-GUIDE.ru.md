...
Диалог комнаты собран в четыре карточки: **Основное** (название и зона Home
Assistant в одну строку), **Заливка**, **Источники** (датчики температуры и
влажности) и **Размеры шрифтов**. Пояснение к каждой карточке открывается
кнопкой «?» рядом с её заголовком.
