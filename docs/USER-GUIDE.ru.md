...
| Перемещаемое ребро покрывает только часть длинной толстой стены | Покрытая часть сохраняет толщину и следует за комнатой, а продолжение остаётся на прежнем месте |
| На стене разная толщина/виртуальный участок | Каждый покрытый интервал толщины и виртуальности переносится вместе со стеной |
...
После преобразования точно совпадающей перегородки инструменты **Толщина** и
**Граница** работают с единственной общей стеной. Поэтому толщину можно задать
