...
- колесо, кнопки `−`/`+`, «Вписать всё», стрелка возврата и двойной тап в
  киоске используют короткий плавный переход камеры; частые события колеса
  меняют текущую цель, а не выстраиваются в очередь;
