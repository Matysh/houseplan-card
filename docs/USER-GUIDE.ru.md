...
| Виртуальная стена | Две точки общей стены | Делает выбранный участок виртуальным; работает только на границе двух комнат |
| Физическая стена | Существующий пунктирный участок | Восстанавливает реальную стену на выбранном виртуальном участке |
...
| Закрытие | Отдельный инструмент «Физическая стена» восстанавливает реальную стену по клику на пунктир |
