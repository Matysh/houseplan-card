...
Карточка сохранит в кадре все комнаты, стены, перегородки, колонны и полный
размах символов проёмов, включая отдельное корректное крыло, но не будет
расширять кадр ради подложки, декора, подписей комнат и маркеров устройств.
