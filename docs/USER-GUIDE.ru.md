...
временном счётчике. Это снимок соседства, а не маршрут каждого текущего пакета.
На touch/pen, в киоске, редакторах и статической карточке слой не появляется;
само наведение никогда не запускает сканирование.
